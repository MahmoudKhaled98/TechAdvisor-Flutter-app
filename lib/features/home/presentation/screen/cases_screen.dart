                                        ...
                                        return GestureDetector(
                                          ...
                                          child: ItemCard(
                                            ...
                                            addingToBuildBtn:AddToBuildBtn(
                                              addToBuildTap: () {
                                                context.read<CaseBloc>().add(SelectCaseEvent(CaseEntity.fromMap(searchedItems[index])));
                                                showDialog(
                                                  context: context,
                                          ...
                                          builder: (context,caseEntity) {
                                            return ListView.builder(
                                              ...
                                              itemBuilder: (context, index) {
                                                ...
                                                final isSelected = state1
                                                    .selectedIndices
                                                    .contains(cases[index].id);
                                                final path = isSelected
                                                    ? 'assets/svg_icons/starSelected.svg'
                                                    : 'assets/svg_icons/starUnselected.svg';
                                                return GestureDetector(
                                                  onTap: () async{
                                                    await urlLauncher.launchPage(cases[index].pageUrl);
                                                  },
                                                  child: ItemCard(
                                                    objectName: cases[index]
                                                        .name,
                                                    objectImageUrl: cases[index]!
                                                        .imageUrl,
                                                    objectSpecs: cases[index]!
                                                        .manufacturer,
                                                    objectPrice: cases[index]!
                                                        .price,
                                                    favBtn: FavBtn(
                                                      isSelected: isSelected,
                                                      path: path,
                                                    ...
                                                    addingToBuildBtn: AddToBuildBtn(
                                                      addToBuildTap: () {
                                                        context.read<CaseBloc>().add(SelectCaseEvent(cases[index]));
                                                        showDialog(
                                                          context: context,
                                                          builder: (BuildContext context) {
                                                            return const MySvgDialog();
