                        ...
                        child: Column(
                          children: [
                            SearchBarWidget(onChanged: (text) {
                              itemsSearchBloc.add(
                                  SearchTextChanged(text, 'monitors'));
                            }),
                                        ...
                                        return GestureDetector(
                                          ...
                                          child: ItemCard(
                                            ...
                                            addingToBuildBtn:AddToBuildBtn(
                                              addToBuildTap: () {
                                                context.read<MonitorBloc>().add(SelectMonitorEvent(MonitorEntity.fromMap(searchedItems[index])));
                                                showDialog(
                                                  context: context,
                                            ...
                                            return ListView.builder(
                                              ...
                                              itemBuilder: (context, index) {
                                                ...
                                                return GestureDetector(
                                                  ...
                                                  child: ItemCard(
                                                    objectName: monitors[index]
                                                        .name,
                                                    objectImageUrl: monitors[index]!
                                                        .imageUrl,
                                                    objectSpecs: monitors[index]!
                                                        .manufacturer,
                                                    objectPrice: monitors[index]!
                                                        .price,
                                                    favBtn: FavBtn(
                                                      isSelected: isSelected,
                                                      path: path,
                                                    ...
                                                    addingToBuildBtn: AddToBuildBtn(
                                                      addToBuildTap: () {
                                                        context.read<MonitorBloc>().add(SelectMonitorEvent(monitors[index]));
                                                        showDialog(
                                                          context: context,
                                                          builder: (BuildContext context) {
                                                            return const MySvgDialog();
