...
class MotherboardsScreen extends StatelessWidget {
                        ...
                        child: Column(
                          children: [
                            SearchBarWidget(onChanged: (text) {
                              itemsSearchBloc.add(
                                  SearchTextChanged(text, 'Motherboards'));
                            }),
                                        ...
                                        await urlLauncher.launchPage(
                                          ...
                                          child: ItemCard(
                                            ...
                                            addingToBuildBtn: AddToBuildBtn(
                                              addToBuildTap: () {
                                                context.read<MotherboardBloc>().add(SelectMotherboardEvent(MotherboardEntity.fromMap(searchedItems[index])));
                                                showDialog(
                                                  context: context,
                                          ...
                                          builder: (context,motherboard) {
                                            return ListView.builder(
                                              ...
                                              itemBuilder: (context, index) {
                                                ...
                                                final isSelected = state1
                                                    .selectedIndices
                                                    .contains(motherboards[index].id);
                                                final path = isSelected
                                                    ? 'assets/svg_icons/starSelected.svg'
                                                    : 'assets/svg_icons/starUnselected.svg';
                                                return GestureDetector(
                                                  ...
                                                  child: ItemCard(
                                                    objectName: motherboards[index]
                                                        .name,
                                                    objectImageUrl: motherboards[index]!
                                                        .imageUrl,
                                                    objectSpecs: motherboards[index]!
                                                        .manufacturer,
                                                    objectPrice: motherboards[index]!
                                                        .price,
                                                    favBtn: FavBtn(
                                                      isSelected: isSelected,
                                                      path: path,
                                                        ...
                                                        //Remove item from favorites
                                                            ...
                                                            FavoriteEvent.addFavorite(
                                                                FavoriteEntity(
                                                                    ...
                                                                    motherboards[index]
                                                                        .name,
                                                                    id: motherboards[index]
                                                                        .id,
                                                                    manufacturer:
                                                                    motherboards[index]
                                                                        .manufacturer,
                                                                    price: motherboards[index]
                                                                        .price,
                                                                    imageUrl:
                                                                    motherboards[index]
                                                                        .imageUrl)));
                                                    ...
                                                    addingToBuildBtn: AddToBuildBtn(
                                                      addToBuildTap: () {
                                                        context.read<MotherboardBloc>().add(SelectMotherboardEvent(motherboards[index]));
                                                        showDialog(
                                                          context: context,
                                                          builder: (BuildContext context) {
                                                            return const MySvgDialog();
