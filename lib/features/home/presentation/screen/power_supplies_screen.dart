...
class PowerSuppliesScreen extends StatelessWidget {
                        ...
                        child: Column(
                          children: [
                            SearchBarWidget(onChanged: (text) {
                              itemsSearchBloc.add(
                                  SearchTextChanged(text, 'power_supplies'));
                            }),
                                        ...
                                        return GestureDetector(
                                          ...
                                          child: ItemCard(
                                            ...
                                            addingToBuildBtn:AddToBuildBtn(
                                              addToBuildTap: () {
                                                context.read<PowerSupplyBloc>().add(SelectPowerSupplyEvent(PowerSupplyEntity.fromMap( searchedItems[index])));
                                                showDialog(
                                                  context: context,
                            ...
                            return BlocBuilder<FirebaseDataSourceBloc,FirebaseDataSourceState>(
                              builder: (context, state) {
                                return state.when(
                                  ...
                                  loaded: (powerSupplies) =>
                                      BlocBuilder<PowerSupplyBloc, PowerSupplyEntity?>(
                                          builder: (context,selectedPowerSupply) {
                                            return ListView.builder(
                                              itemCount: powerSupplies!.length,
                                              itemBuilder: (context, index) {
                                                bloc.getFavoritesIds();
                                                final isSelected = state1
                                                    .selectedIndices
                                                    .contains(powerSupplies[index].id);
                                                final path = isSelected
                                                    ? 'assets/svg_icons/starSelected.svg'
                                                    : 'assets/svg_icons/starUnselected.svg';
                                                return GestureDetector(
                                                  ...
                                                  child: ItemCard(
                                                    objectName: powerSupplies[index]
                                                        .name,
                                                    objectImageUrl: powerSupplies[index]!
                                                        .imageUrl,
                                                    objectSpecs: powerSupplies[index]!
                                                        .manufacturer,
                                                    objectPrice: powerSupplies[index]!
                                                        .price,
                                                    favBtn: FavBtn(
                                                      isSelected: isSelected,
                                                      path: path,
                                                        ...
                                                        //Remove item from favorites
                                                            ...
                                                            FavoriteEvent.addFavorite(
                                                                FavoriteEntity(
                                                                    ...
                                                                    powerSupplies[index]
                                                                        .name,
                                                                    id: powerSupplies[index]
                                                                        .id,
                                                                    manufacturer:
                                                                    powerSupplies[index]
                                                                        .manufacturer,
                                                                    price: powerSupplies[index]
                                                                        .price,
                                                                    imageUrl:
                                                                    powerSupplies[index]
                                                                        .imageUrl)));
                                                    ...
                                                    addingToBuildBtn: AddToBuildBtn(
                                                      addToBuildTap: () {
                                                        context.read<PowerSupplyBloc>().add(SelectPowerSupplyEvent(powerSupplies[index]));
                                                        showDialog(
                                                          context: context,
                                                          builder: (BuildContext context) {
                                                            return const MySvgDialog();
