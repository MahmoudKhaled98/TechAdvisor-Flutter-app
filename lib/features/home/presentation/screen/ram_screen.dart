                                        ...
                                        return GestureDetector(
                                          ...
                                          child: ItemCard(
                                            ...
                                            addingToBuildBtn:AddToBuildBtn(
                                              addToBuildTap: () {
                                                context.read<RamBloc>().add(SelectRamEvent(RamEntity.fromMap( searchedItems[index])));
                                                showDialog(
                                                  context: context,
                                            ...
                                            return ListView.builder(
                                              ...
                                              itemBuilder: (context, index) {
                                                ...
                                                return GestureDetector(
                                                  ...
                                                  child: ItemCard(
                                                    objectName: rams[index]
                                                        .name,
                                                    objectImageUrl: rams[index]!
                                                        .imageUrl,
                                                    objectSpecs: rams[index]!
                                                        .manufacturer,
                                                    objectPrice: rams[index]!
                                                        .price,
                                                    favBtn: FavBtn(
                                                      isSelected: isSelected,
                                                      path: path,
                                                    ...
                                                    addingToBuildBtn: AddToBuildBtn(
                                                      addToBuildTap: () {
                                                        context.read<RamBloc>().add(SelectRamEvent(rams[index]));
                                                        showDialog(
                                                          context: context,
                                                          builder: (BuildContext context) {
                                                            return const MySvgDialog();
