    ...
    return Scaffold(
      ...
      appBar: AppBar(
        title: const Padding(
          ...
          child: Text('Speakers', style: TextStyle(fontFamily: 'Schyler',
          ...
          return BlocBuilder<FirebaseDataSourceBloc, FirebaseDataSourceState>(
            builder: (context, state) {
              return state.when(
                ...
                loaded: (speakers) => ListView.builder(
                  itemCount: speakers!.length,
                  itemBuilder: (context, index) {
                    bloc.getFavoritesIds();
                    final isSelected =
                    state1.selectedIndices.contains(speakers[index].id);
                    final path = isSelected
                        ? 'assets/svg_icons/starSelected.svg'
                        : 'assets/svg_icons/starUnselected.svg';
                    return ItemCard(
                        objectName: speakers[index].name,
                        objectImageUrl: speakers[index]!.imageUrl,
                        objectSpecs: speakers[index]!.manufacturer,
                        objectPrice: speakers[index]!.price,
                        favBtn: FavBtn(isSelected: isSelected, path: path, onTap: () {
                          ...
                          //Remove item from favorites
                              ...
                              FavoriteEvent.addFavorite(FavoriteEntity(
                                  ...
                                  manufacturer:
                                  speakers[index].manufacturer,
                                  price: speakers[index].price,
                                  imageUrl:
