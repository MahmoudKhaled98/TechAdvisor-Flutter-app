                        ...
                        child: Column(
                          children: [
                            SearchBarWidget(onChanged: (text) {
                              itemsSearchBloc.add(
                                  SearchTextChanged(text, 'storage'));
                            }),
                                        ...
                                        return GestureDetector(
                                          ...
                                          child: ItemCard(
                                            ...
                                            addingToBuildBtn:AddToBuildBtn(
                                              addToBuildTap: () {
                                                context.read<GraphicCardBloc>().add(SelectStorageEvent(StorageEntity.fromMap(searchedItems[index])));
                                                showDialog(
                                                  context: context,
                                            ...
                                            return ListView.builder(
                                              ...
                                              itemBuilder: (context, index) {
                                                ...
                                                return GestureDetector(
                                                  ...
                                                  child: ItemCard(
                                                    objectName: storages[index]
                                                        .name,
                                                    objectImageUrl: storages[index]!
                                                        .imageUrl,
                                                    objectSpecs: storages[index]!
                                                        .manufacturer,
                                                    objectPrice: storages[index]!
                                                        .price,
                                                    favBtn: FavBtn(
                                                      isSelected: isSelected,
                                                      path: path,
                                                    ...
                                                    addingToBuildBtn: AddToBuildBtn(
                                                      addToBuildTap: () {
                                                        context.read<StorageBloc>().add(SelectStorageEvent(storages[index]));
                                                        showDialog(
                                                          context: context,
                                                          builder: (BuildContext context) {
                                                            return const MySvgDialog();
